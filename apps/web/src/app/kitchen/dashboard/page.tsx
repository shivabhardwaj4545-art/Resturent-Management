...
import { playKitchenOrderSound, playWaiterCallSound } from '@/utils/audio';
      ...
      <header className="bg-slate-900 border-b border-slate-800 px-6 py-4 flex items-center justify-between shadow-xl sticky top-0 z-30">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="p-2.5 bg-amber-500/10 hover:bg-amber-500/20 text-amber-400 rounded-xl transition-all border border-amber-500/30 text-xs font-bold flex items-center gap-1 active:scale-95"
